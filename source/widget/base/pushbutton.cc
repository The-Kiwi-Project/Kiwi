...
namespace kiwi::widget {
    ...
    PushButton::PushButton(QWidget* child, QWidget* parent, LUI_BTN_INDICATOR_POS indicatorPos, const QColor& colorScheme)
        : QWidget(parent), _childWidget(child), _indicatorPosition(indicatorPos)
    {
        generateColor(colorScheme);
        initializeUI();
    }
    ...
    void PushButton::generateColor(const QColor& colorScheme) {
