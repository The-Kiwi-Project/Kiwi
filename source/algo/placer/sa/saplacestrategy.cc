...
namespace kiwi::algo {
    ...
    auto SAPlaceStrategy::evaluate_placement(
        ...
        debug::info_fmt("Layout evaluation: Line length: {}, congestion: {}, thermal distribution: {}, power consumption: {}, total cost: {}", wirelength, congestion, thermal, power, total_cost);     
        return total_cost;
    }
